...
# from roboticstoolbox.backends.VPython.common_functions import vector, x_axis_vector
...
#         vertex0 = vertex(
#             pos=vec(point0[0], point0[1], point0[2]), normal=normal, color=color.white
#         )
#         vertex1 = vertex(
#             pos=vec(point1[0], point1[1], point1[2]), normal=normal, color=color.white
#         )
#         vertex2 = vertex(
#             pos=vec(point2[0], point2[1], point2[2]), normal=normal, color=color.white
#         )
...
# def set_stl_origin(
#     stl_obj, current_obj_origin, required_obj_origin, scene
# ):  # pragma nocover
#     """
