...
# --------------------------------------------------------------------- #
    ...
    def ikine_con(self, T, q0=None, ilimit=1000, tol=1e-16, stiffness=0, costfun=None):
        r"""
        ...
        This method uses the Scipy trust-constr minimizer to minimize the
        squared norm of a vector :math:`[d,a]` with components respectively the
